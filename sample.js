    ...
    class Slot {
        ...
        lotteryRole() {
            // 役抽選
            let ROLE_WEIGHT = [380, 600, 855, 975, 990, 1000];
            let type = 0;
    ...
    (function () {
        ...
        function vm() {
            ...
            function viewEventBinder() {
                let leftBtn = document.querySelector("#leftStop");
                let centerBtn = document.querySelector("#centerStop");
                let rightBtn = document.querySelector("#rightStop")
